...
build scala-ide-2.1-m2 http://download.scala-ide.org/ecosystem/e37/scala29/dev/site 2.9.3-scala-ide-m2 e37-scala29-m2 http://download.eclipse.org/releases/indigo/
build scala-ide-2.1-m2 http://download.scala-ide.org/ecosystem/e38/scala29/dev/site 2.9.3-scala-ide-m2 e38-scala29-m2 http://download.eclipse.org/releases/juno/
build scala-ide-2.1-m2-2_10 http://download.scala-ide.org/ecosystem/next/e37/scala210/dev/site/ 2.10.0-RC5 e37-scala210-m2 http://download.eclipse.org/releases/indigo/
build scala-ide-2.1-m2-2_10 http://download.scala-ide.org/ecosystem/next/e38/scala210/dev/site/ 2.10.0-RC5 e38-scala210-m2 http://download.eclipse.org/releases/juno/
...
mvn -Drepo.dest=${TARGET_DIR}/combined -Drepo.source=file://${TARGET_DIR}/e37-scala29-m2 package
mvn -Drepo.dest=${TARGET_DIR}/combined -Drepo.source=file://${TARGET_DIR}/e38-scala29-m2 package
mvn -Drepo.dest=${TARGET_DIR}/combined -Drepo.source=file://${TARGET_DIR}/e37-scala210-m2 package
mvn -Drepo.dest=${TARGET_DIR}/combined -Drepo.source=file://${TARGET_DIR}/e38-scala210-m2 package
