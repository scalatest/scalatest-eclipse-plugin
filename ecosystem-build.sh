...
build scala-ide-4.0-2_11-luna http://download.scala-ide.org/sdk/lithium/e44/scala211/dev/site/ 2.11.1 e44-scala211-4.0 http://download.eclipse.org/releases/luna/
